...
<div class="music-player-container" :class="{'is-playing':isPlaying}">
  ...
  <div class="music-player">
    <div class="player-content-container">
      <h1 class="artist-name">{{currentMusic.singer}}</h1><!--  /.track-title -->
  ...
  <div class="album">
    <div class="album-art" :style="`background: #fff url(${currentMusic.photo}) center/cover no-repeat;`"></div><!--  /.album-art -->
    <div class="vinyl" :style="`background: #fff url('./assets/index.png'), url(${currentMusic.photo}) center/cover no-repeat;`"></div><!--  /.vinyl -->
  </div><!--  /.album-art -->
